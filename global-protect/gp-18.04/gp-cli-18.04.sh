...
sudo rm -r ~/Downloads/GlobalProtect_deb-6.1.2.0-82.deb -f
cd ~/Downloads/
##########################################################################################################
...
xdg-open https://torcrobotics-my.sharepoint.com/:u:/r/personal/juan_molleda_torc_ai/Documents/Network-documents/GP-Ubuntu-18.04-Installer/GlobalProtect_deb-6.1.2.0-82.deb?download=1
sleep 1
...
ls ~/Downloads | grep GlobalProtect_UI_deb-6.1.2.0-82.deb && ls ~/Downloads | grep GlobalProtect_deb-6.1.2.0-82.deb
read -p "Is GlobalProtect_UI_deb-6.1.2.0-82.deb and GlobalProtect_deb-6.1.2.0-82.deb present in the directory? Press ENTER key to continue."
##########################################################################################################
...
if [ ! -f "GlobalProtect_deb-6.1.2.0-82.deb" ]; then
   echo -e "\x1b[41;37mGlobalProtect_deb-6.1.2.0-82.deb not found, Please restart Script.\x1b[K\x1b[0m" &&
   exit
     fi
##########################################################################################################
sudo apt-get install resolvconf
sudo apt-get install gir1.2-gtk-3.0 gir1.2-webkit2-4.0
sudo dpkg --force-all -i GlobalProtect_UI_deb-6.1.2.0-82.deb; sudo apt-get -f install -y; sudo dpkg -i GlobalProtect_deb-6.1.2.0-82.deb
...
sudo rm -r ~/Downloads/GlobalProtect_UI_deb-6.1.2.0-82.deb
