...
#Confluence Link
xdg-open https://torc.atlassian.net/wiki/download/attachments/665066314/GlobalProtect_UI_focal_deb-6.1.2.0-82.deb?api=v2
#MS SharePoint Link
...
ls ~/Downloads | grep GlobalProtect_UI_focal_deb-6.1.2.0-82.deb
read -p "Is GlobalProtect_UI_focal_deb-6.1.2.0-82.deb present in the directory? Press ENTER key to continue."
##########################################################################################################
...
sudo dpkg --force-all -i GlobalProtect_UI_focal_deb-6.1.2.0-82.deb; sudo apt-get -f install -y
##########################################################################################################
