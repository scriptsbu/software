...
while true;do
  ...
  case "${QUESTION}" in
    [Yy] ) 
      ...
      "alias tvpn="sudo openconnect vpn.torcrobotics.com --authgroup=Employee-Split-Push"" --user=ahmed.saber && resetdns'alias resetdns='sudo systemd-resolve --flush-caches' | sudo tee -a ~/.bashrc && 
