...
read -p "\x1b[41;37m A browser will launch Confluence to access a file, login, close the browser window, and return to this screen. Please press [ENTER] to proceed.\x1b[K\x1b[0m"
